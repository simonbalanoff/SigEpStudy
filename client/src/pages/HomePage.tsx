    ...
    return (
        <div className="page home-page">
            <section className="home-hero">
                <div>
                    <span className="eyebrow">Colorado Gamma Study Bank</span>

                    <h1>Hey {user?.firstName}, what are you studying?</h1>
            ...
            <section className="home-grid">
                <article className="home-panel">
                    <header className="home-panel-header">
                        ...
                        <Link className="home-panel-link" to="/library">
                            View all
                        </Link>
                    </header>
                        ...
                        {recentQuery.isLoading ? (
                            ...
                            <div className="home-panel-empty">
                                ...
                                <div>
                                    ...
                                    <p>Approved resources will appear here.</p>
                                </div>
                ...
                <article className="home-panel">
                    <header className="home-panel-header">
                        <div>
                            ...
                            <p>Track anything currently being reviewed.</p>
                        </div>

                        <Link className="home-panel-link" to="/submissions">
                            See all
                        </Link>
                    </header>
                        ...
                        {mineQuery.isLoading ? (
                            ...
                            <div className="home-panel-empty">
                                ...
                                <div>
                                    ...
                                    <p>
                                        Your pending submissions will appear
                                        here.
                                    </p>
                                </div>
