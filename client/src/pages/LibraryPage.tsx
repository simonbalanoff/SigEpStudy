...
export function LibraryPage() {
    ...
    useEffect(
        () => setPage(1),
        [debouncedQuery, course, professorId, resourceType, sort],
    );
    ...
    const hasFilters = Boolean(
        course || professorId || resourceType || sort !== "newest",
    );
    ...
    return (
        <div className="page">
            <PageHeader
                title="Library"
                description="Search all approved Colorado Gamma study resources."
            />
            ...
            <Card className="library-controls">
                <div className="library-search">
                    ...
                    <input
                        ...
                        placeholder="Search titles, topics, or course names"
            ...
            <div className="results-heading">
                <span>
                    <Filter size={16} />{" "}
                    {resourcesQuery.data?.pagination.total ?? 0} resources
                </span>
            </div>
            ...
            <PaginationControls
                page={page}
                pages={resourcesQuery.data?.pagination.pages ?? 1}
                onChange={setPage}
            />
        </div>
    );
