...
async function run(): Promise<void> {
  ...
  if (!inputPath) throw new Error("Usage: npm run import:courses -- data/courses.json");
  ...
  console.log(`Created ${result.upsertedCount}; updated ${result.modifiedCount}; matched ${result.matchedCount}.`);
}
