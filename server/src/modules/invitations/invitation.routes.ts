...
const invitationLimiter = rateLimit({ windowMs: 15 * 60 * 1000, limit: 250, standardHeaders: true, legacyHeaders: false });
...
invitationAdminRouter.patch("/invitations/:invitationId/deactivate", deactivateInvitation);
